...
if(document.addEventListener ){
   ...
   aLoader = [
      { load: "https://code.jquery.com/jquery-1.8.3.js"},
      { load: "https://animate.adobe.com/runtime/3.0.0/edge.3.0.0.min.js"},
      { load: "dengi_edge.js"},
      { load: "dengi_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="850px",maxPlW="1440px",plWidth="100%",plHeight="250px";
